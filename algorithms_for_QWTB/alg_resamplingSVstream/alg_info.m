...
% Part of QWTB. Info script for algorithm resamplingSVstream
%
% See also qwtb

alginfo.id = 'resamplingSVstream';
alginfo.name = 'Resampling the SV data stream';
...
alginfo.inputs(6).name = 'max_rel_A_err';
alginfo.inputs(6).desc = 'Maximum relative error of the signal amplitude';
alginfo.inputs(6).alternative = 0;
alginfo.inputs(6).optional = 1;
alginfo.inputs(6).parameter = 0;

alginfo.inputs(7).name = 'AA_stop';
alginfo.inputs(7).desc = 'Stop frequency of the anti-aliasing filter (Hz). Overriden by AA_filter.';
alginfo.inputs(7).alternative = 0;
alginfo.inputs(7).optional = 1;
alginfo.inputs(7).parameter = 0;

alginfo.inputs(8).name = 'AA_ripple';
alginfo.inputs(8).desc = 'Relative passband ripple of the anti-aliasing filter. Overriden by AA_filter.';
alginfo.inputs(8).alternative = 0;
alginfo.inputs(8).optional = 1;
alginfo.inputs(8).parameter = 0;

alginfo.inputs(9).name = 'AA_att';
alginfo.inputs(9).desc = 'Attenuation of the anti-aliasing filter (dB). Overriden by AA_filter.';
alginfo.inputs(9).alternative = 0;
alginfo.inputs(9).optional = 1;
alginfo.inputs(9).parameter = 0;

alginfo.inputs(10).name = 'SPP';
alginfo.inputs(10).desc = 'Required number of samples per period of the signal';
