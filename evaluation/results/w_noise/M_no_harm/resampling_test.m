...
%% General settings ---------------------------------------- %<<<1
file_prefix = 'M_no_harm_-_'; % file prefix for plots and data
multiple_harmonics = 0 % will correctly process data and plots inside of this script
...
%         % SigParamVar.f.v = [SigParamVar.f.v; 3.*tmp]';
...
%---
% % sampling frequency
% SigParamVar.fs.v = [4000 : 1000 : 96000];
% SigParamVar.fs.v = [4000 20000 96000];
% xaxisquantity = 'fs.v';
