...
`proc_SAMMU_waveform_gui` is used to calculate signal properties using
...
1. Download
[this script proc_SAMMU_waveform_gui.m](https://github.com/KaeroDot/EPMDigitalITsw/blob/main/gui/proc_SAMMU_waveform_gui.m "Script proc_SAMMU_waveform_gui.m")
    using "Download raw file" on the right side of the linked webpage:

    ![Download RAW file on Github](help_img/proc_SAMMU_waveform_gui_help_image_02.png)

    and save it to your computer.
1. Run GNU Octave and Matlab, and run the downloaded script by typing command `proc_SAMMU_waveform_gui`.

### 3.1 Manual installation

1. Download [this script proc_SAMMU_waveform_gui.m](https://github.com/KaeroDot/EPMDigitalITsw/blob/main/gui/proc_SAMMU_waveform_gui.m "Script proc_SAMMU_waveform_gui.m").
...
![Main GUI window](help_img/proc_SAMMU_waveform_gui_help_image_01.png)
...
![Conversion window](help_img/proc_SAMMU_waveform_gui_help_image_05.png)
...
`proc_SAMMU_waveform_gui.m` software.
...
of seqData as PhsMeas`:
    ...
    ![Wireshark setting IEC61850 protocol](help_img/proc_SAMMU_waveform_gui_help_image_03.png)
...
1. Export data as csv file using menu `File->Export Packet Dissections->As
   CSV`:
    ...
    ![Wireshark export](help_img/proc_SAMMU_waveform_gui_help_image_04.png)
...
`proc_SAMMU_waveform_gui` can convert such a file into a simple `.csv` by using `tshark` (part of Wireshark). See section [Conversion window](#4.2-conversion-window).
